        ...
        <div id="tambahBeritaForm" style="display: none;">
            <div class="card card-primary mb-3">
                <div class="card-header">
                    <h3 class="card-title">Tambah Kategori Materi</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <!-- form start -->
                ...
                <form action="{{ route('kategori-materi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nama</th>
                            <th>Aksi</th> <!-- Tambahkan kolom untuk tombol edit dan hapus -->
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol edit -->
                                <a href="{{ route('kategori-materi.edit', $item->kode) }}" class="btn btn-warning">Edit</a>

                                <!-- Form hapus -->
                                <form action="{{ route('kategori-materi.destroy', $item->kode) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
